...
describe("DashboardCardComponent", () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [DashboardCardComponent, NavbarComponent],
      providers: [
  ...
  it("should expect to emit an event having identifyCard equal to 1 and cardData equal to films data when the components collectionsData has a key called director", inject(
    ...
    collectionsService => {
      ...
      component.detailedCardIdentification = {
        films: 1,
        characters: 2,
        planets: 3
      };
      component.data = films;
      component.collectionsData = films;
      spyOn(component.onInformationRequest, "emit");
      component.onMoreInformationRequest();
      fixture.detectChanges();
      expect(component.onInformationRequest.emit).toHaveBeenCalledWith({
        identifyCard: 1,
        cardData: component.data
      });
    }
  ));
});
