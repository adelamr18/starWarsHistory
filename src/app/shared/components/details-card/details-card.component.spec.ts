...
describe("DetailsCardComponent", () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [DetailsCardComponent, NavbarComponent],
      providers: [
        {
          provide: Router,
          useClass: class {
  ...
  it("should expect to set the collections service paramaters related to the card details from the defines files when setCharacterFurtherDetails is invoked", inject(
    [CollectionsServiceService],
    collectionsService => {
      component.setCharacterFurtherDetails();
      expect(collectionsService.cardDetailOne).toEqual("Character details");
      expect(collectionsService.cardDetailTwo).toEqual("Größe");
      expect(collectionsService.cardDetailThree).toEqual("Gewicht");
      expect(collectionsService.cardDetailFour).toEqual("Haarfarbe");
      expect(collectionsService.cardDetailFive).toEqual("Augenfarbe");
      expect(collectionsService.cardDetailSix).toEqual("Geburtsjahr");
      expect(collectionsService.cardDetailSeven).toEqual("Geschlecht");
      expect(collectionsService.cardDetailEight).toEqual("Heimatplanet");
    }
  ));

  it("should expect to set the collections service paramaters related to the card details from the defines files when setFilmFurtherDetails is invoked", inject(
    [CollectionsServiceService],
    collectionsService => {
      component.setFilmFurtherDetails();
      expect(collectionsService.cardDetailOne).toEqual("Film details");
      expect(collectionsService.cardDetailTwo).toEqual("Director");
      expect(collectionsService.cardDetailThree).toEqual("Produzenten");
      expect(collectionsService.cardDetailFour).toEqual("Erscheinungsdatum");
  ...
  it("should expect to display all films data and navigate to films path when films genre is selected from the navbar and   ", inject(
    ...
    (collectionsService, router: Router) => {
      ...
      expect(collectionsService.currenentDisplayedCards).toEqual(films);
